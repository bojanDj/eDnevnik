...
<div id = "probaGo" style=" width: 49%; margin-top: 5%; margin-left: 10%;">
                ...
                <h2>Ispravite ocenu</h2>
                <form:form action="${pageContext.request.contextPath}/admin/odeljenja/${razred}/${ocena.ucenik.ucenikID}/${ocena.ocenaID}/updateGrade" method="POST" modelAttribute="ocenaAtr">
                <div class="form-group">
                  <form:label path = "broj" for="ocena">Ocena</form:label>
                  <form:input type="text" class="form-control" id ="broj" placeholder="Ocena" value="${ocena.broj}" path = "broj"/>
                </div>
                <div class="form-group">
                   <form:label path = "tipOcene.tipOceneID" for="sel1">Izaberite tip ocene</form:label>
                    <form:select class="form-control" id="sel1" path = "tipOcene.tipOceneID" value = "${ocena.tipOcene.tipOceneID}">
